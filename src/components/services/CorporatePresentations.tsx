...
const packages = [
  ...
  },
  {
    ...
    recommended: false,
    bonus:
      "Landing page com todas as informações da associação + domínio e hospedagem de 1 ano + 3 emails corporativos",
  },
];

export const CorporatePresentations = () => {
  return (
    <>
      {/* O que vamos fazer */}
      <Section>
          ...
          <div className="max-w-4xl mx-auto mt-12 grid gap-6">
            ...
            <Card className="p-6 flex items-start gap-4 hover:shadow-[var(--shadow-elegant)] transition-all">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Entrega do ficheiro .pptx editável + PDF, tudo pronto para uso.
                </p>
              </div>
            </Card>
          </div>
...
export default CorporatePresentations;
